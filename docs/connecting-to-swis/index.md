...
Because of current limitation, LOCAL connection via AD group account or with `-Trusted` option is not allowed. You can either use certificate for connection or connect from remote machine.