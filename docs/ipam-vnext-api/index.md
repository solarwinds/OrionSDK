...
/// <param name="subnetId">Optional GroupId of the subnet containing the IP address. When provided, the IP is looked up within that specific subnet.
/// When null or not specified, the IP is looked up globally by address.</param>
public void ChangeIpStatus(string ipAddress, string status, int? subnetId = null)
```

subnetId support available since 2026.2
...
Invoke-SwisVerb $swis IPAM.SubnetManagement ChangeIPStatus @("199.10.1.1", "Used", 100)
```
...
```csharp
/// <summary>
/// Add a range of IPv4 addresses to an existing IPv4 subnet.
/// For subnets with CIDR larger than /20, IP addresses are not created automatically and must be added via this verb.
/// </summary>
/// <param name="subnetGroupId">GroupId of the IPv4 subnet</param>
/// <param name="startIp">First IPv4 address of the range, e.g. "10.0.0.1"</param>
/// <param name="endIp">Last IPv4 address of the range (inclusive), e.g. "10.0.0.100"</param>
public void AddIpRange(int subnetGroupId, string startIp, string endIp)
```

Sample

```powershell
Invoke-SwisVerb $swis IPAM.SubnetManagement AddIpRange @(100, "10.0.0.1", "10.0.0.100")
```
...
```csharp
/// <summary>
/// Add a range of IPv6 addresses to an existing IPv6 subnet.
/// </summary>
/// <param name="subnetGroupId">GroupId of the IPv6 subnet</param>
/// <param name="startIp">First IPv6 address of the range, e.g. "2001:db8::1"</param>
/// <param name="endIp">Last IPv6 address of the range (inclusive), e.g. "2001:db8::64"</param>
public void AddIpv6Range(int subnetGroupId, string startIp, string endIp)
```

Sample

```powershell
Invoke-SwisVerb $swis IPAM.SubnetManagement AddIpv6Range @(200, "2001:db8::1", "2001:db8::64")
```
...
```csharp
/// <summary>
/// Remove a range of IP addresses (IPv4 or IPv6) from an existing subnet.
/// Only addresses that are currently managed (exist in IPAM) will be removed.
/// </summary>
/// <param name="subnetGroupId">GroupId of the subnet (IPv4 or IPv6)</param>
/// <param name="startIp">First IP address of the range to remove</param>
/// <param name="endIp">Last IP address of the range to remove (inclusive)</param>
public void RemoveIpRange(int subnetGroupId, string startIp, string endIp)
```

Sample

```powershell
Invoke-SwisVerb $swis IPAM.SubnetManagement RemoveIpRange @(100, "10.0.0.1", "10.0.0.100")

Invoke-SwisVerb $swis IPAM.SubnetManagement RemoveIpRange @(200, "2001:db8::1", "2001:db8::64")
```
...
///     int GroupId;
///     int ParentId;
/// Following properties are available since 2025.4:
///     string Address;
///     int CIDR;
///     string Description;
///     string VLAN;
...
Available since 2025.4

```csharp
/// <summary>
/// Edit Supernet
/// </summary>
/// <param name="id">Supernet GroupId</param>
/// <param name="name">Supernet name</param>
/// <param name="cidr">CIDR</param>
/// <param name="description">Description</param>
public void EditSupernet(int id, string name, int cidr, string description)
```

Sample

```powershell
Invoke-SwisVerb $swis IPAM.SupernetManagement EditSupernet @(1, "Supernet name", 24, "Example description")
```

# Get all group nodes by name

Available since 2025.2

```csharp
/// <summary>
/// Get all group nodes with given name
/// </summary>
/// <param name="groupNodeName">Group Node name</param>
/// <returns>
/// List of GetGroupNodeDto, where GetGroupNodeDto is type like:
/// {
///     int GroupId;
///     int ParentId;
///     int GroupType;
...
/// }
/// </returns>
public List<GetGroupNodeDto> GetAllGroupNodesByName(string groupNodeName)
```

Group type can be one of the following values:
...
```powershell
Invoke-SwisVerb $swis IPAM.GroupManagement GetAllGroupNodesByName @("Group Node Name")
```

# Remove group (including children)
...
```powershell
Invoke-SwisVerb $swis IPAM.GroupManagement RemoveGroup @(100)
```
...
/// <param name="newCredentialUserName">New credential username. If not creating new credentials pass null</param>
/// <param name="newCredentialPassword">New credential password. If not creating new credentials pass null</param>
/// <param name="newCredentialProtocol">New credential protocol. CISCO, ASA, ISC: Telnet = 0, SSH = 1. Default value is SSH (1). Kea: HTTP = 0, HTTPS = 1. Default value is HTTPS (1). If not creating new credentials pass null.</param>
/// <param name="newCredentialClientPort">New credential port (maps to Ipv4Port for Kea). CISCO, ASA, ISC: default is 22 (SSH). Kea: default is 443 (HTTPS) or 80 (HTTP) based on the selected protocol. If not creating new credentials pass null.</param>
/// <param name="newCredentialEnableLevel">CISCO and ASA only. New credential enable level property. No enable login = -2, enable = -1, enable 0 = 0 ... . If not creating new credentials pass null. Default value is -2 (No enable login)</param>
/// <param name="newCredentialEnablePassword">CISCO and ASA only. New credential enable password property. If not creating new credentials pass null</param>
...
/// <param name="serverType">Type of the DHCP server. Unknown = 0, Windows = 1, CISCO = 2, ASA = 3, ISC = 4, Infoblox = 5, Kea = 6. Default value is Windows (1)</param>
...
/// <param name="newCredentialIpv6Username">Kea only. IPv6 username for authentication. Default value is null</param>
/// <param name="newCredentialIpv6Password">Kea only. IPv6 password for authentication. Default value is null</param>
/// <param name="newCredentialUseAuthentication">Kea only. Whether authentication is enabled. Default value is false</param>
/// <param name="newCredentialEnableIpv4Credentials">Kea only. Whether IPv4 credentials are enabled. Default value is false</param>
/// <param name="newCredentialEnableIpv6Credentials">Kea only. Whether IPv6 credentials are enabled. Default value is false</param>
/// <param name="newCredentialIpv6Port">Kea only. IPv6 port number. Default value is null</param>
/// <returns>Operation result: "Operation was successful" or "Operation failed"</returns>
public string AddDhcpServer(int nodeId, string newHierarchyGroupName, string newCredentialName,
    string newCredentialUserName,
    string newCredentialPassword, string newCredentialEnablePassword, int? newCredentialProtocol = 1,
    int? newCredentialClientPort = 22,
    ...
    string newCredentialIpv6Username = null, string newCredentialIpv6Password = null,
    bool newCredentialUseAuthentication = false, bool newCredentialEnableIpv4Credentials = false,
    bool newCredentialEnableIpv6Credentials = false, int? newCredentialIpv6Port = null)
```

KEA support available since 2026.2
...
# Create IPv6 Address reservation on DHCP server
...
/// Create IPv6 Address reservation on DHCP server
/// </summary>
/// <param name="ipAddressToReserve">IPv6 IpNode Address</param>
/// <param name="dhcpServerIpAddress">DHCP Server Address</param>
/// <param name="reservationName">Client Name</param>
/// <param name="duid">DHCP Unique Identifier (DUID). Format: hex pairs separated by dashes, e.g. "00-01-00-01-23-45-67-89"</param>
/// <param name="iaid">Identity Association Identifier (IAID). Decimal number in range 0-4294967295. Required for non-Kea DHCP servers.</param>
/// <returns>Operation result: "Operation was successful" or "Operation failed"</returns>
public string CreateIpv6Reservation(string ipAddressToReserve, string dhcpServerIpAddress, string reservationName, string duid, string iaid = null)
```

Sample

```powershell
Invoke-SwisVerb $swis IPAM.DhcpDnsManagement CreateIpv6Reservation @("2001:db8::1","199.10.1.0","testName", "00-01-00-01-23-45-67-89", "1234")
```
...
# Remove IPv6 address reservation from DHCP server

Available since 2026.2

```csharp
/// <summary>
/// Remove IPv6 Address reservation from DHCP
/// </summary>
/// <param name="ipRemoveReservation">IPv6 IpNode Address</param>
/// <param name="dhcpServerIpAddress">DHCP Server Address</param>
/// <returns>Operation result: "Operation was successful" or "Operation failed"</returns>
public string RemoveIpv6Reservation(string ipRemoveReservation, string dhcpServerIpAddress)
```

Sample

```powershell
Invoke-SwisVerb $swis IPAM.DhcpdnsManagement RemoveIpv6Reservation @("2001:db8::1", "10.199.1.150")
```
