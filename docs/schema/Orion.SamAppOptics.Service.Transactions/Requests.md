...
# Orion.SamAppOptics.Service.Transactions.Requests
...
| Name | Type | Notes |
| ------ | ------ | ------ |
| ApplicationPool | [Orion.APM.IIS.ApplicationPool](./../Orion.APM.IIS/ApplicationPool) | Defined by relationship AppOptics.ApplicationPoolToTransactionsRequests (System.Hosting) |
